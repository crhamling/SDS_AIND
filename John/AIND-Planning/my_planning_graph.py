...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        """
        return bool(
            # Actions from node 1 negated by actions in node 2
            set(node_a1.action.effect_add) & set(node_a2.action.effect_rem) |

            # Actions from node 2 negated by actions in node 1
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        """
        return bool(
            # Actions in node 1 equivalent to the negation of a precondition of node 2
            set(node_a1.action.effect_add) & set(node_a2.action.precond_neg) |
            set(node_a1.action.effect_rem) & set(node_a2.action.precond_pos) |

            # Actions in node 2 equivalent to the negation of a precondition of node 1
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # For each parent, find mutually exclusive
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        # Verify both states represent the same symbol and one is the negation of the other
